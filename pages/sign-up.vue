<template>
    <div class="flex flex-col gap-12 w-full md:w-3/5 xl:w-100">
                ...
                <UFormField label="Mật khẩu">
                    ...
                    <div v-if="form.password" class="mt-2">
                        <div class="flex gap-1 h-1 mb-1">
                            <div v-for="i in 5" :key="i" class="flex-1 rounded-full transition-all duration-300"
...
function onUsernameInput() {
    ...
    usernameTimer = setTimeout(async () => {
        try {
            ...
            usernameState.available = false
            usernameState.message =
                e?.data?.message || 'Tên đăng nhập đã tồn tại'
        } finally {
            usernameState.checking = false
        }
    }, 100)
